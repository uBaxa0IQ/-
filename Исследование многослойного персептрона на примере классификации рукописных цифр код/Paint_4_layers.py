import pygame
import tensor as tf
from file4_6_weights0_1 import weights0_1
from file4_6_weights1_2 import weights1_2
from file4_6_weights2_3 import weights2_3
...
while running:
    ...
    for i in range(len(layer_3)):
        if i == tf.mass_argmax(layer_3):
            color = RED
        else:
            color = BLACK
        draw_text(screen, str(i) + ' : ' + str(round(layer_3[i] * 100, 1)), 50, 970, Lenght / 10 * i, color)
